      ...
      <div className="pt-32 pb-20 lg:pt-40 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {programs.map((prog, idx) => (
            <div key={idx} className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col h-full group">
              <div className="flex-1">
                <div className="inline-flex items-center space-x-2 bg-slate-100 rounded-full px-3 py-1 mb-6 border border-slate-200">
                  ...
                  <span className="text-[10px] font-bold text-slate-600 uppercase tracking-wider">MSME Sponsored</span>
                </div>
