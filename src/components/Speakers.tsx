          ...
          {speakers.map((speaker, idx) => (
            <div key={idx} className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
              <div className="relative mb-6 flex justify-center">
                ...
                {/* LinkedIn Badge */}
                <a href="#" aria-label={`LinkedIn of ${speaker.name}`} className="absolute bottom-0 right-1/2 translate-x-12 translate-y-2 bg-[#0A66C2] text-white p-2 rounded-full border-2 border-white hover:bg-blue-700 transition-colors shadow-md">
